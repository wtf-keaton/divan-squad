...
namespace offsets
{
    static uintptr_t level = 0x30;
    static uintptr_t actors = 0x98;
    static uintptr_t gameinstance = 0x170;
    static uintptr_t localplayer = 0x38;
    static uintptr_t playercontroller = 0x30;


    static uintptr_t rootcomponent = 0x160;
    static uintptr_t relaticelocation = 0x144;
    static uintptr_t instigator = 0x148;

    static uintptr_t meshcomponent = 0x2a8;
    static uintptr_t playerstate = 0x268;

    static uintptr_t playername = 0x350;
   
    static uintptr_t controlrotation = 0x2b0;
    static uintptr_t acknowledgedpawn = 0x2c8;

    static uintptr_t teamid = 0x420;
    static uintptr_t soldier = 0x730;
    static uintptr_t soldiermovement = 0x710;
    static uintptr_t health = 0x1c18;

    static uintptr_t sprint = 0x758;
}

#ifdef _DEBUG
#define debug_log( str, ... ) printf_s( str, __VA_ARGS__ )
#else
...
public:
    class ULevel* getLevel( )
    {
        ...
        return *( ULevel** ) ( this + offsets::level );
    }

    class UGameInstance* getOwningGameInstance( )
    {
        if ( this == nullptr )
        {
            debug_log( _( "Nullptr getted in function: %s \n" ), _( __FUNCTION__ ) );
...
public:
    TArray< class AActor* > getActors( )
    {
        ...
        return *( TArray< class AActor* >* ) ( this + offsets::actors );
    }
};
...
public:
    class APawn* getInstigator( )
    {
        ...
        return *( APawn** ) ( this + offsets::instigator );
    }
...
{
public:
    TArray< class ULocalPlayer* > getLocalPlayer( )
    {
        if ( this == nullptr )
        {
            debug_log( _( "Nullptr getted in function: %s \n" ), _( __FUNCTION__ ) );
        ...
        return *( TArray< class ULocalPlayer* > * ) ( this + offsets::localplayer );
    }
};
...
public:
    ...
    class APawn* getAcknowledgedPawn( )
    {
        ...
        return *( APawn** ) ( this + offsets::acknowledgedpawn );
    }
};
...
public:
    Vector3 getRelativeLocation( )
    {
        ...
        return *( Vector3* ) ( this + offsets::relaticelocation );
    }
};
...
public:
    ...
    class USkeletalMeshComponent* getMesh( )
    {
        ...
        return *( USkeletalMeshComponent** ) ( this + offsets::meshcomponent );
    }
};
...
public:
    FString getNickname( )
    {
        ...
        return *( FString* ) ( this + offsets::playername );
    }
    ...
    uint32_t getTeamID( )
    {
        ...
        return *( uint32_t* ) ( this + offsets::teamid );
    }
    ...
    class ASQSoldier* getSoldier( )
    {
        ...
        return *( ASQSoldier** ) ( this + offsets::soldier );
    }
};
...
{
public:
    class USQSoldierMovement* getSoldierMovement( )
    {
        if ( this == nullptr )
        {
            debug_log( _( "Nullptr getted in function: %s \n" ), _( __FUNCTION__ ) );
        ...
        return *( USQSoldierMovement** ) ( this + offsets::soldiermovement );
    }
    ...
    float getHealth( )
    {
        ...
        return *( float* ) ( this + offsets::health );
    }
};

class USQSoldierMovement
{
public:
    float setSprintSpeedMultiplier( float value )
    {
        if ( this == nullptr )
        {
            debug_log( _( "Nullptr getted in function: %s \n" ), _( __FUNCTION__ ) );
        ...
        return *( float* ) ( this + offsets::sprint ) = value;
    }
};
